...
class UserTableViewDelegate: TableViewDelegate<UserModel> {
    ...
    override init() {
        ...
        detailViewControllerPresenter = UserDetailViewControllerPresenter()
...
class RepositoryTableViewDelegate: TableViewDelegate<RepositoryModel> {
    ...
    override init() {
        ...
        detailViewControllerPresenter = RepositoryDetailViewControllerPresenter()
        contextMenuConfigurator = TableViewContextMenuConfigurator()
    }
...
class OrganizationTableViewDelegate: TableViewDelegate<OrganizationModel> {
    ...
    override init() {
        ...
        detailViewControllerPresenter = OrganizationDetailViewControllerPresenter()
        contextMenuConfigurator = TableViewContextMenuConfigurator()
    }
...
class CommitTableViewDelegate: TableViewDelegate<CommitModel> {
    ...
    override init() {
        ...
        detailViewControllerPresenter = CommitDetailViewControllerPresenter()
        contextMenuConfigurator = TableViewContextMenuConfigurator()
    }
